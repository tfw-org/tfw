...
public final class ShortIlaCheck
{
    ...
    public static void checkAll(ShortIla target, ShortIla actual,
    ...
    public static void checkWithoutCorrectness(ShortIla ila,
                                               int offsetLength,
                                               short epsilon)
        throws Exception
    {
    ...
    public static void checkZeroArgImmutability(ShortIla ila)
        throws Exception
    {
    ...
    public static void checkTwoArgImmutability(ShortIla ila,
                                               short epsilon)
        throws Exception
    {
    ...
    public static void checkTwoFourEquivalence(ShortIla ila,
                                               short epsilon)
        throws Exception
    {
        final short eps = epsilon < 0.0 ? (short) -epsilon : epsilon;
    ...
    public static void checkFourFiveEquivalence(ShortIla ila, 
                                                int offsetLength,
                                                short epsilon)
        throws Exception
    {
    ...
    public static void checkCorrectness(ShortIla target, ShortIla actual,
                                        int addlOffsetLength, int maxAbsStride,
                                        short epsilon)
        throws Exception
    {
