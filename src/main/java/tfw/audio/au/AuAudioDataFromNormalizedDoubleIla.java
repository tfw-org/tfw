...
public class AuAudioDataFromNormalizedDoubleIla {
    ...
    public static ByteIla create(DoubleIla doubleIla, long auEncoding, int bufferSize) {
        Argument.assertNotNull(doubleIla, "doubleIla");

        if (auEncoding == Au.ISDN_U_LAW_8_BIT) {
            return MuLawByteIlaFromLinearShortIla.create(
                    ShortIlaFromCastDoubleIla.create(
                            DoubleIlaRound.create(DoubleIlaScalarMultiply.create(
                                    DoubleIlaClip.create(doubleIla, -1.0, 1.0, bufferSize), Math.pow(2.0, 15.0) - 1.0)),
                            bufferSize),
                    bufferSize);
        } else if (auEncoding == Au.LINEAR_8_BIT) {
            return ByteIlaFromCastDoubleIla.create(
                    DoubleIlaRound.create(DoubleIlaScalarMultiply.create(
                            DoubleIlaClip.create(doubleIla, -1.0, 1.0, bufferSize), Math.pow(2.0, 7.0) - 1.0)),
                    bufferSize);
            ...
            return ByteIlaFromIntIla.create(
                    IntIlaFromCastDoubleIla.create(
                            DoubleIlaRound.create(DoubleIlaScalarMultiply.create(
                                    DoubleIlaClip.create(doubleIla, -1.0, 1.0, bufferSize), Math.pow(2.0, 31.0) - 1.0)),
                            bufferSize),
                    bufferSize);
            ...
            return ByteIlaFromIntIla.create(
                    IntIlaFromFloatIla.create(
                            FloatIlaFromCastDoubleIla.create(
                                    DoubleIlaClip.create(doubleIla, -1.0, 1.0, bufferSize), bufferSize),
                            bufferSize),
                    bufferSize);
        } else if (auEncoding == Au.IEEE_FLOATING_POINT_64_BIT) {
            return ByteIlaFromLongIla.create(
                    LongIlaFromDoubleIla.create(DoubleIlaClip.create(doubleIla, -1.0, 1.0, bufferSize), bufferSize),
                    bufferSize);
