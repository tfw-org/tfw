...
class SetForegroundFactoryTest {
    ...
    void testArguments() {
        ...
        assertThrows(IllegalArgumentException.class, () -> SetForegroundFactory.create(null, COLOR_ECD, jButton, null));
        assertThrows(IllegalArgumentException.class, () -> SetForegroundFactory.create(TEST_NAME, null, jButton, null));
        assertThrows(
                IllegalArgumentException.class, () -> SetForegroundFactory.create(TEST_NAME, COLOR_ECD, null, null));
    }
