...
public abstract class AbstractDoubleIba implements DoubleIba {
    protected abstract void closeImpl() throws IOException;

    protected abstract BigInteger lengthImpl() throws IOException;

    protected abstract void getImpl(final double[] array, int arrayOffset, BigInteger ibaStart, int length)
            throws IOException;
    ...
    public final BigInteger length() throws IOException {
        if (closed) {
            throw new IllegalStateException("This DoubleIba is closed!");
        }
    ...
    @Override
    public final void get(double[] array, int arrayOffset, BigInteger ibaStart, int length) throws IOException {
        if (closed) {
            throw new IllegalStateException("This DoubleIba is closed!");
        }
