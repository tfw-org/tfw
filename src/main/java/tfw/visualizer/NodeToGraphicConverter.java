...
public class NodeToGraphicConverter extends Converter {
    ...
    public NodeToGraphicConverter(
            Component component,
            GraphECD graphECD,
            IntIlmECD pixelNodeTLBRECD,
            FontECD fontECD,
            ColorECD backgroundColorECD,
            ColorECD branchColorECD,
            ColorECD commitColorECD,
            ColorECD converterColorECD,
            ColorECD eventChannelColorECD,
            ColorECD initiatorColorECD,
            ColorECD multiplexedBranchColorECD,
            ColorECD rootColorECD,
            ColorECD synchronizerColorECD,
            ColorECD triggeredCommitColorECD,
            ColorECD triggeredConverterColorECD,
            ColorECD validatorColorECD,
            GraphicECD graphicOutECD) {
        super(
                "NodeToGraphicConverter",
                new ObjectECD[] {
                    graphECD,
                    pixelNodeTLBRECD,
                    fontECD,
                    ...
                    commitColorECD,
                    converterColorECD,
                    eventChannelColorECD,
                    initiatorColorECD,
                    multiplexedBranchColorECD,
                    rootColorECD,
                    synchronizerColorECD,
                    triggeredCommitColorECD,
                    triggeredConverterColorECD,
                    validatorColorECD
                },
                null,
    ...
    protected void convert() {
        ...
        try {
            ...
            graph.toArray(nodes, 0, 0, (int) graph.nodesLength(), null, null, 0, 0, 0);
        } catch (Exception e) {
            return;
        }
        ...
        for (int i = 0; i < nodes.length; i++) {
            ...
            if (proxy instanceof BranchProxy) foregroundColor = branchColor;
            else if (proxy instanceof CommitProxy) foregroundColor = commitColor;
            else if (proxy instanceof ConverterProxy) foregroundColor = converterColor;
            else if (proxy instanceof EventChannelProxy) foregroundColor = eventChannelColor;
            else if (proxy instanceof InitiatorProxy) foregroundColor = initiatorColor;
            else if (proxy instanceof MultiplexedBranchProxy) foregroundColor = multiplexedBranchColor;
            else if (proxy instanceof RootProxy) foregroundColor = rootColor;
            else if (proxy instanceof SynchronizerProxy) foregroundColor = synchronizerColor;
            else if (proxy instanceof TriggeredCommitProxy) foregroundColor = triggeredCommitColor;
            else if (proxy instanceof TriggeredConverterProxy) foregroundColor = triggeredConverterColor;
            else if (proxy instanceof ValidatorProxy) foregroundColor = validatorColor;
            ...
            graphic = DrawStringGraphic.create(graphic, proxy.getName(), left, bottom - descent);
        }
