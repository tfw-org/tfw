...
public final class StridedIntIla {
    private final IntIla ila;
    private final int[] buffer;

    public StridedIntIla(final IntIla ila, final int[] buffer) {
    ...
    public void toArray(final int[] array, final int offset, final int stride, final long start, final int length)
            throws IOException {
