...
/**
 * Defines the rule for what constitutes a state change
 * on an event channel. Notification of a state change will
 * only occur if {@link #isChange(Object, Object)} returns 
 * <code>true</code>
 */
