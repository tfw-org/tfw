...
public class JTextFieldModifiableBB extends JTextFieldBB
{
	...
	{
		this(new Branch("JTextFieldModifiableBB["+name+"]"),
			textECD, textAdjECD, enabledECD, applyECD);
	}
			...
			StatelessTriggerECD applyECD)
	{
		...
		branch.add(new ForegroundBackgroundHandler(
			branch.getName(), textECD, textAdjECD, enabledECD));
		branch.add(new EventChannelCopyConverter(
			branch.getName(), textECD, textAdjECD));
	}
