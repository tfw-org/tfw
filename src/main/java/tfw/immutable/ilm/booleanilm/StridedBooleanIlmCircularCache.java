...
public class StridedBooleanIlmCircularCache {
    private StridedBooleanIlmCircularCache() {}

    public static StridedBooleanIlm create(StridedBooleanIlm stridedIlm, int numRows, boolean[] buffer) {
    ...
    private static class MyBooleanIlm extends AbstractStridedBooleanIlm {
        ...
        public MyBooleanIlm(StridedBooleanIlm stridedIlm, int numRows, boolean[] buffer) {
