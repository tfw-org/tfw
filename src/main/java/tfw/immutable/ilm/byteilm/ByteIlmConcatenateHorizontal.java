...
{
    private ByteIlmConcatenateHorizontal() {}

    public static ByteIlm create(ByteIlm leftIlm, ByteIlm rightIlm)
    {
		...
		return new MyByteIlm(leftIlm, rightIlm);
    }
    	...
    	implements ImmutableProxy
    {
		...
		MyByteIlm(ByteIlm leftIlm, ByteIlm rightIlm)
		{
