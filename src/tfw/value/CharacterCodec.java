 ...
 *
 */
public class CharacterCodec implements ValueCodec
{
    ...
    public static CharacterCodec getInstance()
    {
        return INSTANCE;
    }
    ...
    public Object decode(String value) throws CodecException
    {
        ...
        if (value.length() != 1)
        {
            throw new CodecException("Error decoding value, '" + value + "'");
        }
    ...
    public String encode(Object value) throws CodecException
    {
        ...
        if (!(value instanceof Character))
        {
            throw new CodecException(
                "Error encoding value. The specified value is not a java.lang.Character");
        }
