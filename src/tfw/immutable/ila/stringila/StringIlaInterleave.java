...
public final class StringIlaInterleave
{
    ...
    private static class MyStringIla extends AbstractStringIla implements
        ImmutableProxy
    {
        ...
        protected void toArrayImpl(String[] array, int offset, int stride,
        ...
        public Map getParameters()
        {
            ...
            map.put("name", "StringIlaInterleave");
