...
public final class ObjectIlaMutate
{
    ...
    public static ObjectIla create(ObjectIla instance, long index,
		Object value)
    {
		...
		return new MyObjectIla(instance, index, value);
    }
    ...
    private static class MyObjectIla extends AbstractObjectIla
    {
		...
		MyObjectIla(ObjectIla instance, long index, Object value)
		{
