...
public class BooleanIlaFromArrayTest extends TestCase
{
	public void testBooleanIlaFromArray()
		throws DataInvalidException
	{
		...
		try
		{
			BooleanIlaFromArray.create(null);
		...
		for (int s=0 ; s < LENGTH ; s++)
		{
			...
			{
				boolean[] a1 = new boolean[l];
				System.arraycopy(array, s, a1, 0, l);
				boolean[] a2 = ila.toArray(s, l);
