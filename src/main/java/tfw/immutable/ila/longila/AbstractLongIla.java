 ...
 */
public abstract class AbstractLongIla
    extends AbstractIla
    implements LongIla
{
    ...
    public final long[] toArray(long start, int length)
        throws DataInvalidException
    {
    ...
    public final void toArray(long[] array, int offset,
    ...
    public final void toArray(long[] array, int offset, int stride,
                              long start, int length)
        throws DataInvalidException
    {
        if(length == 0)
