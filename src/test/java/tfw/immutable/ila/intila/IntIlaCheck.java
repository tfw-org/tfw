...
public final class IntIlaCheck
{
    ...
    public static void checkAll(IntIla target, IntIla actual,
    ...
    public static void checkWithoutCorrectness(IntIla ila,
                                               int offsetLength,
                                               int epsilon)
        throws Exception
    {
    ...
    public static void checkZeroArgImmutability(IntIla ila)
        throws Exception
    {
    ...
    public static void checkTwoArgImmutability(IntIla ila,
                                               int epsilon)
        throws Exception
    {
    ...
    public static void checkTwoFourEquivalence(IntIla ila,
                                               int epsilon)
        throws Exception
    {
        final int eps = epsilon < 0.0 ? (int) -epsilon : epsilon;
    ...
    public static void checkFourFiveEquivalence(IntIla ila, 
                                                int offsetLength,
                                                int epsilon)
        throws Exception
    {
    ...
    public static void checkCorrectness(IntIla target, IntIla actual,
                                        int addlOffsetLength, int maxAbsStride,
                                        int epsilon)
        throws Exception
    {
