...
import tfw.immutable.ila.intila.IntIlaSubtract;
import tfw.immutable.ila.intila.IntIlaFromArray;

public class IntIlaSubtractTest extends TestCase
{
	public void testIntIlaSubtract()
	{
		...
		try
		{
			IntIlaSubtract.create(null, ila2);
