...
public class VisualizerToolBar extends JPanelBB {
    ...
    public VisualizerToolBar() {
        ...
        JToggleButtonBB selectionTB = new JToggleButtonBB("Selection", SELECTION_ENABLED_ECD, TOOL_SELECTED_ECD);
        selectionTB.setText("Sele");
        JToggleButtonBB moveTB = new JToggleButtonBB("Move", MOVE_ENABLED_ECD, TOOL_SELECTED_ECD);
        moveTB.setText("Move");
