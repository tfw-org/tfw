...
public abstract class AbstractShortIlm extends AbstractIlm
	implements ShortIlm
{
    ...
    public final short[] toArray(long rowStart, long columnStart,
    	int rowCount, int colCount) throws DataInvalidException
    {
    ...
    public final void toArray(short[] array, int offset, long rowStart,
    ...
    public final void toArray(short[] array, int offset, int rowStride,
