...
public class ImmutableProxyVisualizer {
    public ImmutableProxyVisualizer(ImmutableProxy proxy) {
        JFrame frame =
                new JFrame("ImmutableProxy Visualizer: " + proxy.getParameters().get("name"));
    ...
    private static DefaultMutableTreeNode createTreeNode(ImmutableProxy proxy) {
        ...
        DefaultMutableTreeNode currentNode =
                new DefaultMutableTreeNode(name == null ? proxy.getClass().toString() : name.toString());
        ...
        for (Iterator i = map.keySet().iterator(); i.hasNext(); ) {
            ...
            if (!(value instanceof ImmutableProxy)) {
                currentNode.add(new DefaultMutableTreeNode(key.toString() + " = " + value.toString()));
            }
        }
