...
public final class FloatIlaSegment
{
    ...
    public static FloatIla create(FloatIla instance, long start)
    {
		return create(instance, start, instance.length() - start);
    }

    public static FloatIla create(FloatIla instance, long start, long length)
    {
		...
		return new MyFloatIla(instance, start, length);
    }
    ...
    private static class MyFloatIla extends AbstractFloatIla
    {
		...
		MyFloatIla(FloatIla instance, long start, long length)
		{
		    super(length);
