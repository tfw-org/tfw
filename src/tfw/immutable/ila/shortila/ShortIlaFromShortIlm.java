...
import tfw.immutable.ilm.shortilm.AbstractShortIlm;
import tfw.immutable.ilm.shortilm.ShortIlm;

public final class ShortIlaFromShortIlm
{
    private ShortIlaFromShortIlm() {}

    public static ShortIla create(ShortIlm ilm)
    {
    	Argument.assertNotNull(ilm, "ilm");

		return new MyShortIla(ilm);
    }

    private static class MyShortIla extends AbstractShortIla
    	implements ImmutableProxy
    {
		private ShortIlm ilm;

		MyShortIla(ShortIlm ilm)
		{
		...
		{
			short[][] tempArray = new short[][] {array};
		...
		public Map getParameters()
		{
			...
			map.put("name", "ShortIlaFromShortIlm");
			map.put("ilm", AbstractShortIlm.getImmutableInfo(ilm));
