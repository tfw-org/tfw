...
public final class FloatIlaCheck
{
    ...
    public static void checkAll(FloatIla target, FloatIla actual,
    ...
    public static void checkWithoutCorrectness(FloatIla ila,
                                               int offsetLength,
                                               float epsilon)
        throws Exception
    {
    ...
    public static void checkZeroArgImmutability(FloatIla ila)
        throws Exception
    {
    ...
    public static void checkTwoArgImmutability(FloatIla ila,
                                               float epsilon)
        throws Exception
    {
    ...
    public static void checkTwoFourEquivalence(FloatIla ila,
                                               float epsilon)
        throws Exception
    {
        final float eps = epsilon < 0.0 ? (float) -epsilon : epsilon;
    ...
    public static void checkFourFiveEquivalence(FloatIla ila, 
                                                int offsetLength,
                                                float epsilon)
        throws Exception
    {
    ...
    public static void checkCorrectness(FloatIla target, FloatIla actual,
                                        int addlOffsetLength, int maxAbsStride,
                                        float epsilon)
        throws Exception
    {
