...
import tfw.immutable.ila.byteila.ByteIlaMutate;

public class ByteIlaMutateTest extends TestCase
{
	public void testByteIlaMutate()
	{
		final Random random = new Random();
		final int LENGTH = 29;
		
		byte[] array = new byte[LENGTH];
		byte element = (byte)random.nextInt();
		...
		try
		{
			ByteIlaMutate.create(null, 0, element);
		...
		try
		{
			ByteIlaMutate.create(ila, -1, element);
		...
		try
		{
			ByteIlaMutate.create(ila, LENGTH, element);
