...
public class InterleavedMagnitudeDoubleIlmTest extends TestCase {
	public void testInterleavedMagnitudeDoubleIlm() throws Exception {
		DoubleIla doubleIla = DoubleIlaFromArray.create(new double[] {
