...
public final class BooleanIlaSegment
{
    ...
    public static BooleanIla create(BooleanIla instance, long start)
    {
		return create(instance, start, instance.length() - start);
    }

    public static BooleanIla create(BooleanIla instance, long start, long length)
    {
		...
		return new MyBooleanIla(instance, start, length);
    }
    ...
    private static class MyBooleanIla extends AbstractBooleanIla
    {
		...
		MyBooleanIla(BooleanIla instance, long start, long length)
		{
		    super(length);
