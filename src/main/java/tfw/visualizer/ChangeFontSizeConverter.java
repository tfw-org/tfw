...
public class ChangeFontSizeConverter extends TriggeredConverter {
    ...
    public ChangeFontSizeConverter(String name, StatelessTriggerECD triggerECD, FontECD fontECD, float scale) {
        super("IncreaseFontConverter[" + name + "]", triggerECD, new ObjectECD[] {fontECD}, new ObjectECD[] {fontECD});
