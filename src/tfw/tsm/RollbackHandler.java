...
/**
 *    The base class for all event handling components which participate
 * in transaction rollbacks.
 */
abstract class RollbackHandler extends EventHandler
{
     ...
     * @param sinkDescriptions the descriptions of the sinks.
     * @param sourceDescriptions the descriptions of the sources.
     */
    ...
    /**
     * Causes a rollback of the current transaction. All
     * event channels which participate in rollbacks will be set back to
     * their state prior to the initiation of the current transaction.
     */
	...
	/**
	 * Causes a rollback of  the current transaction and sets the state
	 * of the specified event channel in a follow-on transaction.
	 * 
	 * @param ecd The event channel on which the state is to be set.
