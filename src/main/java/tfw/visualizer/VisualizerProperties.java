...
public class VisualizerProperties extends JPanelBB {
    ...
    public VisualizerProperties() {
        ...
        ColorButtonNB backgroundCB = new ColorButtonNB(
                "Background", BACKGROUND_COLOR_ECD, BACKGROUND_COLOR_ENABLED_ECD, "Background Color", this);
        colorButtonsPanel.addToBoth(backgroundCB);
        ColorButtonNB branchCB =
                new ColorButtonNB("Branch", BRANCH_COLOR_ECD, BRANCH_COLOR_ENABLED_ECD, "Branch Color", this);
        colorButtonsPanel.addToBoth(branchCB);
        ColorButtonNB commitCB =
                new ColorButtonNB("Commit", COMMIT_COLOR_ECD, COMMIT_COLOR_ENABLED_ECD, "Commit Color", this);
        colorButtonsPanel.addToBoth(commitCB);
        ColorButtonNB converterCB = new ColorButtonNB(
                "Converter", CONVERTER_COLOR_ECD, CONVERTER_COLOR_ENABLED_ECD, "Converter Color", this);
        colorButtonsPanel.addToBoth(converterCB);
        ColorButtonNB eventChannelCB = new ColorButtonNB(
                "EventChannel", EVENTCHANNEL_COLOR_ECD, EVENTCHANNEL_COLOR_ENABLED_ECD, "EventChannel Color", this);
        colorButtonsPanel.addToBoth(eventChannelCB);
        ColorButtonNB initiatorCB = new ColorButtonNB(
                "Initiator", INITIATOR_COLOR_ECD, INITIATOR_COLOR_ENABLED_ECD, "Initiator Color", this);
        colorButtonsPanel.addToBoth(initiatorCB);
        ColorButtonNB multiplexedBranchCB = new ColorButtonNB(
                "MultiplexedBranch",
                MULTIPLEXEDBRANCH_COLOR_ECD,
                MULTIPLEXEDBRANCH_COLOR_ENABLED_ECD,
                "MultiplexedBranch Color",
                this);
        colorButtonsPanel.addToBoth(multiplexedBranchCB);
        ColorButtonNB rootCB = new ColorButtonNB("Root", ROOT_COLOR_ECD, ROOT_COLOR_ENABLED_ECD, "Root Color", this);
        colorButtonsPanel.addToBoth(rootCB);
        ColorButtonNB synchronizerCB = new ColorButtonNB(
                "Synchronizer", SYNCHRONIZER_COLOR_ECD, SYNCHRONIZER_COLOR_ENABLED_ECD, "Synchronizer Color", this);
        colorButtonsPanel.addToBoth(synchronizerCB);
        ColorButtonNB triggeredCommitCB = new ColorButtonNB(
                "TriggeredCommit",
                TRIGGEREDCOMMIT_COLOR_ECD,
                TRIGGEREDCOMMIT_COLOR_ENABLED_ECD,
                "TriggeredCommit Color",
                this);
        colorButtonsPanel.addToBoth(triggeredCommitCB);
        ColorButtonNB triggeredConverterCB = new ColorButtonNB(
                "TriggeredConverter",
                TRIGGEREDCONVERTER_COLOR_ECD,
                TRIGGEREDCONVERTER_COLOR_ENABLED_ECD,
                "TriggeredConverter Color",
                this);
        colorButtonsPanel.addToBoth(triggeredConverterCB);
        ColorButtonNB validatorCB = new ColorButtonNB(
                "Validator", VALIDATOR_COLOR_ECD, VALIDATOR_COLOR_ENABLED_ECD, "Validator Color", this);
