...
public final class ${NAME}IlaInterleave {
    ...
    public static ${TEMPLATE_SPACE}${NAME}Ila${TEMPLATE} create(${NAME}Ila${TEMPLATE}[] ilas, final ${TYPE_OR_TEMPLATE}[] buffer) {
    ...
    private static class ${NAME}IlaImpl${TEMPLATE} extends Abstract${NAME}Ila${TEMPLATE} {
        ...
        protected void closeImpl() throws IOException {
            for (Strided${NAME}Ila${TEMPLATE} ila : strided${NAME}Ilas) {
                ila.close();
            }
        }
    }
