...
public final class LongIlmSegment
{
    private LongIlmSegment() { }

    public static LongIlm create(LongIlm instance, long rowStart, long columnStart)
    {
		return create(instance, rowStart, columnStart,
			instance.width() - columnStart, instance.height() - rowStart);
    }

    public static LongIlm create(LongIlm instance, long rowStart,
    	long columnStart, long width, long height)
    {
		...
		return new MyLongIlm(instance, rowStart, columnStart, width, height);
    }

    private static class MyLongIlm extends AbstractLongIlm
    {
		private final LongIlm instance;
		private final long rowStart;
		private final long columnStart;

		MyLongIlm(LongIlm instance, long rowStart, long columnStart,
