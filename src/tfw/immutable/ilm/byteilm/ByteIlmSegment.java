...
public final class ByteIlmSegment
{
    private ByteIlmSegment() { }

    public static ByteIlm create(ByteIlm instance, long rowStart, long columnStart)
    {
		return create(instance, rowStart, columnStart,
			instance.width() - columnStart, instance.height() - rowStart);
    }

    public static ByteIlm create(ByteIlm instance, long rowStart,
    	long columnStart, long width, long height)
    {
		...
		return new MyByteIlm(instance, rowStart, columnStart, width, height);
    }

    private static class MyByteIlm extends AbstractByteIlm
    {
		private final ByteIlm instance;
		private final long rowStart;
		private final long columnStart;

		MyByteIlm(ByteIlm instance, long rowStart, long columnStart,
