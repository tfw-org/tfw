...
public class EventChannelCopyConverter extends Converter {
    ...
    public EventChannelCopyConverter(String name, ObjectECD inputECD, ObjectECD outputECD) {
        this(name, new ObjectECD[] {inputECD}, new ObjectECD[] {outputECD});
    }

    public EventChannelCopyConverter(String name, ObjectECD[] inputECDs, ObjectECD[] outputECDs) {
