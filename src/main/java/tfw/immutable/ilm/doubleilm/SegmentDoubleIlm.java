...
public class SegmentDoubleIlm {
	...
	public static DoubleIlm create(DoubleIlm doubleIlm, long startingRow,
		long startingColumn, long numberOfRows, long numberOfColumns) {
		...
		Argument.assertNotGreaterThan(startingRow + numberOfRows, doubleIlm.height(),
				"startingRow + numberOfRows", "doubleIlm.height()");
		Argument.assertNotGreaterThan(startingColumn + numberOfColumns, doubleIlm.width(),
				"startingColumn + numberOfColumns,", "doubleIlm.width()");
	...
	private static class MyDoubleIlm extends AbstractDoubleIlm {
		...
		public MyDoubleIlm(DoubleIlm doubleIlm, long startingRow,
				long startingColumn, long numberOfRows, long numberOfColumns) {
		...
		protected void toArrayImpl(double[] array, int offset, int rowStride, int colStride, long rowStart,
			...
			doubleIlm.toArray(array, offset, rowStride, colStride, startingRow + rowStart, startingColumn + colStart, rowCount, colCount);
		}
	}
}
