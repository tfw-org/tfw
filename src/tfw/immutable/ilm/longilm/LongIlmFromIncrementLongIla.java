...
public final class LongIlmFromIncrementLongIla
{
    private LongIlmFromIncrementLongIla() {}

    public static LongIlm create(LongIla ila, BigDecimal rowIncrement,
    	long noDataValue)
    {
    	Argument.assertNotNull(ila, "ila");
    	Argument.assertNotNull(rowIncrement, "rowIncrement");
				
		return new MyLongIlm(ila, rowIncrement, noDataValue);
    }
    	...
    	implements ImmutableProxy
    {
		...
		MyLongIlm(LongIla ila, BigDecimal rowIncrement,
			long noDataValue)
		{
		...
		public Map getParameters()
		{
			...
			map.put("name", "LongIlmFromIncrementLongIla");
			map.put("ila", AbstractLongIla.getImmutableInfo(ila));
			map.put("rowIncrement", rowIncrement);
			map.put("noDataValue", new Long(noDataValue));
