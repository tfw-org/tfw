...
public final class FloatIlaIterator {
    ...
    public FloatIlaIterator(FloatIla instance) {
        this(instance, DEFAULT_BUFFER_SIZE);
    }

    public FloatIlaIterator(FloatIla instance, int bufferSize) {
     ...
     * Either know the length of the FloatIla, or use hasNext()
     * properly.
     */
    public float next() throws DataInvalidException {
