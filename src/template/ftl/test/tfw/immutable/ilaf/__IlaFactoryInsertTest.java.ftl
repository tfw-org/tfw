...
final class ${NAME}IlaFactoryInsertTest {
    @Test
    void argumentTest() {
        assertThatThrownBy(() -> ${NAME}IlaFactoryInsert.create(null, 5, ${DEFAULT_VALUE}))
    ...
    void createTest() {
        ...
        assertThat(${NAME}IlaFactoryInsert.create(f, 5, ${DEFAULT_VALUE_2}).create()).isNotNull();
    }
}
