...
public final class CharIlaCheck
{
    ...
    public static void checkAll(CharIla target, CharIla actual,
    ...
    public static void checkWithoutCorrectness(CharIla ila,
                                               int offsetLength,
                                               char epsilon)
        throws Exception
    {
    ...
    public static void checkZeroArgImmutability(CharIla ila)
        throws Exception
    {
    ...
    public static void checkTwoArgImmutability(CharIla ila,
                                               char epsilon)
        throws Exception
    {
    ...
    public static void checkTwoFourEquivalence(CharIla ila,
                                               char epsilon)
        throws Exception
    {
        final char eps = epsilon < 0.0 ? (char) -epsilon : epsilon;
    ...
    public static void checkFourFiveEquivalence(CharIla ila, 
                                                int offsetLength,
                                                char epsilon)
        throws Exception
    {
    ...
    public static void checkCorrectness(CharIla target, CharIla actual,
                                        int addlOffsetLength, int maxAbsStride,
                                        char epsilon)
        throws Exception
    {
