...
{
	public void testObjectIlaFromArray()
		throws DataInvalidException
	{
		...
		final ObjectIla ila = ObjectIlaFromArray.create(array);
		
		try
		{
			ObjectIlaFromArray.create(null);
		...
		for (int s=0 ; s < LENGTH ; s++)
		{
			...
			{
				Object[] a1 = new Object[l];
				System.arraycopy(array, s, a1, 0, l);
				Object[] a2 = ila.toArray(s, l);
