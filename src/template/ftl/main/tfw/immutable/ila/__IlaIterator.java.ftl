...
public final class ${NAME}IlaIterator${TEMPLATE} {
    ...
    public ${NAME}IlaIterator(${NAME}Ila${TEMPLATE} instance, ${TYPE_OR_TEMPLATE}[] buffer) throws IOException {
     ...
     * Either know the length of the ${NAME}Ila, or use hasNext()
     * properly.
     */
    public ${TYPE_OR_TEMPLATE} next() throws IOException {
